...
'0→1
case 0:
sp_on 0,0:sp_on 2,0:sp_on 1,1:sp_on 3,0:sp_put 1,(5,400),0,0:No=1:pause 200:locate 0,15:print "                                                   ":locate 0,15:print" 2.数霊（かずたま）2人用を選択":goto Kazutama_main:
'デバッグライン　ここから
'0のとき
'デバッグライン　ここまで
'デバッグライン　ここから
case 2:
'2→3
sp_on 2,0:sp_on 1,0:sp_on 2,0:sp_on 3,1:sp_on 0,0:sp_put 3,(5,600),0,0:pause 200:locate 0,15:print "                                               "
:locate 0,15:print " 4.トップ画面に行くを選択":No=3:goto Kazutama_main:
'3→0
case 3:
sp_on 0,1:sp_on 1,0:sp_on 2,0:sp_on 3,0:sp_put 0,(5,300),0,0:pause 200:No=0:locate 0,15:print "                                                    ":locate 0,15:print " 1.数霊(かずたま)1人用を選択":goto Kazutama_main:
case 1:
'1→2
sp_on 2,1:sp_on 1,0:sp_on 0,0:sp_on 3,0:sp_put 2,(5,500),0,0:pause 200:No = 2:locate 0,15:print "                                                  ":locate 0,15:print " 3.数霊（かずたま）リストを選択":goto Kazutama_main:
'デバッグライン　ここから
' locate 1,12:print "b=";b;chr$(13):count=count+1:goto Main_Select:
'デバッグライン　ここまで
end select
...
case 1:
'1→0
sp_on 1,0:sp_on 0,1:sp_on 2,0:sp_on 3,0:sp_put 0,(5,300),0,0:pause 200:No=0:locate 0,15:print"                                     ":locate 0,15:print" 1.数霊（かずたま）1人用を選択":goto Kazutama_main:
'No:3 3.Help→2.設定 No:2o:3 3.Help→2.設定 No:2
case 2:
'2→1
sp_on 1,1:sp_on 0,0:sp_on 2,0:sp_on 3,0:sp_put 1,(5,400),0,0:pause 200:No=1:locate 0,15:print"                                     ":locate 0,15:print" 2.数霊（かずたま）2人用を選択":goto Kazutama_main:
case 3:
'3→2
sp_on 0,0:sp_on 1,0:sp_on 2,1:sp_on 3,0:sp_put 2,(5,500),0,0:pause 200:No=2:locate 0,15:print "                                      ":locate 0,15:print" 3.数霊(かずたま)リストを選択":goto Kazutama_main:
case 0:
'0→3
sp_on 0,0:sp_on 1,0:sp_on 3,1:sp_on 2,0:sp_put 3,(5,600),0,0:pause 200:No=3:locate 0,15:print "                                      ":locate 0,15:print " 4.トップ画面に行くを選択":goto Kazutama_main:
end select
endif
if (bg = 2) then
select case No
