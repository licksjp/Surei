...
'Oct(2025)
'Version 1.6.6_2025.10.11:正式版
'Version 1.6.7_2025.10.26:正式版
'-------------------------------------------------------------------------------------------------------------------------------------
'***************************************************************************************************************************************
'現在のバージョン
Version$ = "数霊_Ver167_20251026"
'***************************************************************************************************************************************
...
sp_on 0,1:sp_put 0,(5,300),0,0:screen 1,1,1,1:
if lang_flag = 1 then
'lang_flag=1 英語
else
'lang_flag=0 日本語
...
'************************************************************************************************************************************************
case 2:
sp_on 0,0:sp_on 1,0:sp_on 2,0:sp_on 3,0:pause 200:n = Kazutama_File_Entry_Check():goto Kazutama_data_Entry_count:
'*************************************************************************************************************************************************
'プログラムの終了を選択
'*************************************************************************************************************************************************
end select
...
'Line3 
'3行目
'Line3 数霊名  表示位置から文字の桁数ずらす。
Line3_Kazutama_Name = Count_Kazutama_Name2 - buf_length1 - 4
'Line3 数霊数　表示位置から文字の桁数ずらす。
Line3_Kazutama_Number = Count_Kazutama_Number2 - buf_length2 - 4
...
'3.結果を表示
'*********************************************************************************************************
'3件の時の文字データー代入処理:(1,0) and (1,1)
'********************************************************************************************************
'登録件数が1件の時の文字データー代入処理
Title1_Kazutama_Line1_Name$ = Buffer_Kazutama_Entry_Data$(1,0)
Title2_Kazutama_Line1_Number$ = Buffer_Kazutama_Entry_Data$(1,1)
buf_length1 = len(Title1_Line1_Kazutama_Name$)
buf_length2 = len((Title2_Line1_Kazutama_Number$))
...
'******************************************************************************************************
'*******************************************************************************************************
'登録件数が3件の時の文字データー代入処理
Title1_Kazutama_Line3_Name$ = Buffer_Kazutama_Entry_Data$(3,0)
Title2_Kazutama_Line3_Number$ = Buffer_Kazutama_Entry_Data$(3,1)
buf_length1 = len(Title1_Line3_Kazutama_Name$)
buf_length2 = len((Title2_Line3_Kazutama_Number$))
'******************************************************************************************************
'●.全データー　3件
'*********************************************************************************************************
'●.1件目
...
'2-2.数霊名 表示位置 黒:rgb(0,0,0)
'*********************************************************************************************************
locate Line3_Kazutama_Name,Line3:color rgb(0,0,0)
'*********************************************************************************************************
'2-2.数霊名　表示する Title1_Kazutama_Line2_Name$
'*********************************************************************************************************
print Title1_Kazutama_Line3_Name$
'*********************************************************************************************************
'2-3.数霊数 表示位置 黒:rgb(0,0,0)
'*********************************************************************************************************
locate Line3_Kazutama_Number,Line3:color rgb(0,0,0)
'*********************************************************************************************************
'2-3.数霊数 表示する Title2_Kazutama_Line2_Number$
'**********************************************************************************************************
print val(Title2_Kazutama_Line3_Number$)
'次のメエニュー表示 ここから
'**********************************************************************************************************
locate 2,15
color rgb(255,255,255)
