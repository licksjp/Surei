...
3240 if No=4 then color rgb(255,255,255):pause 2.052*1000:play Voice_File_TopScreen$+"Voice_Finish_Message.mp3":pause 400:cls 3:end
...
3480 if No=4 then color rgb(255,255,255):pause 2.052*1000:ui_msg"プログラムを終了します":play Voice_File_TopScreen$ + "Voice_Finish_Message.mp3":cls 3:end
