...
case 3:
'3→2
sp_on 0,0:sp_on 1,0:sp_on 2,1:sp_on 3,0:sp_put 2,(5,500),0,0:pause 200:No=2:locate 0,15:print "                                      ":locate 0,15:print" 1.数霊(かずたま)リストを選択":goto Kazutama_main:
case 0:
'0→3
sp_on 0,0:sp_on 1,0:sp_on 3,1:sp_on 2,0:sp_put 3,(5,600),0,0:pause 200:No=3:locate 0,15:print "                                      ":locate 0,15:print " 3.トップ画面に戻るを選択":goto Kazutama_main:
end select
endif
if (bg = 2) then
select case No
