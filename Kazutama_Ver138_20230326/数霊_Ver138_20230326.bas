...
570 '現在のバージョン
580 Version$ = "1.3.8_2023.03.26(正式版)"
590 'csvファイル 1.数霊 ベースファイル
600 FILE_csv$ = "./data/Kazutama.csv"
610 'csvファイル 2.数霊 ベースファイル 2
620 FILE_csv2$ = "./data/Surei_chart_20211207.csv"
630 'Save ファイル
640 SAVE_DATA1$ = "./data/Parsonal_list1.csv"
650 'gazo ファイル
660 Gazo$ = "./data/Gazo/"
670 'System フォルダ:設定ファイルを保存するところ
680 System$ = "./data/System/config.sys"
690 '設定ファイル名:config.sys
700 'Sound File(Voice)
710 '1.ボイス TopScreen
720 Voice_File_TopScreen$ = "./data/Sound_data/"
730 'Message
740 buf_finish_Message$ = "メモリーを解放してプログラムを終了します"
750 '変数領域
760 'vcount:バーチャルパッド下の変数
770 dim bufline$(181 * 2+3),bufcount$(20):count = 0:dim bufcount1$(20):dim bufcount2$(20):mode = 0:dim bufline2$(181+3,2):dim bufline3$(181*2+3):dim bufKaztama$(50,2):c=1:vcount=0:timer=0:dim List$(4):dim Result_Menu_List$(3)
780 count2 = 0:N=0:N2=0:m2 = 0:device_No=0
790 dim list$(4),moji_List$(2)
800 'ファイルの有無チェック
810 if (dir$(FILE_csv$) = "" or dir$(FILE_csv2$) = "" ) then
820 '1.ファイルが無いとき
830 cls :print "依存ファイルが見つかりません":
840 print "エンターキーを押してください" + chr$(13)
850 key$ = input$(1)
860 if key$ = chr$(13) then cls 3:color rgb(255,255,255):end
870 else
880 '2.ファイルが有るとき
890 cls:print "csv:file ok." + chr$(13)
900 n=0
910 'FILE_csv$:数霊データー入力
920 open FILE_csv$ for input as #1
930 while eof(1) = 0
940 input #1,line$
950 bufline$(n) = line$
960 'Print n;chr$(13)
...
1020 '2つ目のファイル読み込み
1030 'n = 0
1040 open FILE_csv2$ for input as #2
1050 for n=3 to 181
1060 for i=0 to 1
1070 input #2,line$
1080 bufline2$(n,i) = line$
1090 next i
1100 next n
1110 close #2
1120 N2 = n
...
1210 lang_flag = 1
1220 endif
1230 cls 3:font 48:screen 1,1,1,1:int "kb:4":init "crt:0"
1240 play ""
1250 'gload Gazo$ + "TopScreen_20230310.png",0,0,0
1260 '選択ポインター 1 - 4
1270 'スプライトの定義
1280 gload Gazo$ + "Selection.png",1,5,300
1290 gload Gazo$ + "Selection.png",1,5,400
1300 gload Gazo$ + "Selection.png",1,5,500
1310 gload Gazo$ + "Selection.png",1,5,595
1320 sp_def 0,(5,300),32,32
1330 sp_def 1,(5,400),32,32
1340 sp_def 2,(5,500),32,32
1350 sp_def 3,(5,595),32,32
1360 'First_Select_Screen:
1370 'タブレット　or　スマホの選択を起動時にする
1380 Device_Select:
1390 font 48:screen 1,1,1,1:init "kb:4":init "crt:0"
1400 gload Gazo$ + "device_select_20230313.png",0,0,0
1410 init "kb:4"
1420 play ""
1430 play Voice_File_TopScreen$+"Select_device_select.mp3"
1440 'y=0:key$="":bg=0
1450 print chr$(13)+chr$(13)+chr$(13)
1460 color  rgb(255,255,255)
1470 print "番号を選んでください"+chr$(13)
1480 'print chr$(13)
1490 print " :1.スマートフォン"+chr$(13)
1500 print " :2.タブレット端末"+chr$(13)
1510 locate 0,11:No=1
1520 color rgb(0,0,0)
1530 Print " 1.スマートフォンを選択"+chr$(13)
1540 sp_on 0,1:sp_put 0,(5,300),0,0
1550 sp_on 1,0:sp_on 2,0:sp_on 3,0
1560 device_selection:
1570 y=0:key$="":bg=0:
1580 While (key$ <> chr$(30) and key$ <> chr$(31) and key$ <> chr$(13) and y <> 1 and y <> -1 and bg <> 1)
1590 y = stick(1)
1600 key$ = inkey$
1610 bg = strig(1)
1620 pause 2
1630 wend
1640 if ((y=1) or (y=-1) or (key$=chr$(30)) or (key$=chr$(31)) ) then
1650 select case No
1660 case 1:
1670       No=2:sp_on 1,1:sp_on 0,0:locate 0,11:pause 300:sp_put 1,(5,400),0,0:print "                                ":locate 0,11:print " 2.タブレット端末を選択":goto device_selection:
1680 case 2:
1690       No=1:sp_on 1,0:sp_on 0,1:pause 300:sp_put 0,(5,300),0,0:locate 0,11:print "                                   ":locate 0,11:print " 1.スマートフォンを選択":goto device_selection:
1700 end select
1710 endif
1720 if ((bg=1) or (key$=chr$(13)))  then
1730 select case No
1740 case 1:
1750       sp_on 0,0:sp_on 1,0:device_No=1:goto TopScreen:
1760 case 2:
1770       sp_on 0,0:sp_on 1,0:device_No=2:goto TopScreen:
1780 end select
1790 endif
1800 'Top画面
1810 TopScreen:
1820 'バーチャルパッドを表示
1830 cls 3:font 48:screen 1,1,1,1:init "kb:4":init "crt:0"
1840 'play ""
1850 play ""
1860 play Voice_File_TopScreen$ + "Voice_TopScreen.mp3"
1870 'gload Gazo$ + "Screen1_Top_20211226.png",0,0,0
1880 select case device_No
1890 case 1:
1900 'Top画面の背景画像
1910 gload Gazo$ + "TopScreen_20230310.png",0,0,0
1920 gload Gazo$ + "downscreen.png",0,0,800
1930 case 2:
1940 gload Gazo$ + "TopScreen_20230310.png",0,0,0
1950 end select
1960 'key$=input$(1)
1970 'バーチャルパッドの背景を白にする for smartphone screen
1980 'gload Gazo$ + "downscreen.png",0,0,800
1990 '選択肢 1
2000 gload Gazo$ + "Selection.png",1,5,300
2010 '選択肢 2
2020 gload Gazo$ + "Selection.png",1,5,400
2030 '選択肢 3
2040 gload Gazo$ + "Selection.png",1,5,500
2050 '選択肢 4
2060 'TopScreen:
2070 'select case device_No
2080 'case 1:
2090 gload Gazo$ + "Selection.png",1,5,590
2100 'case 2:
2110 'gload Gazo$ +
2120 'end select
2130 color rgb(0,0,255)
2140 print chr$(13)
2150 if lang_flag = 1 then
2160 color rgb(255,255,255)
2170 print "Select Number" + chr$(13)
2180 print " :1.Kazutama check" + chr$(13)
2190 print " :2.Setting" + chr$(13)
2200 print " :3.Help" + chr$(13)
2210 print " :4.End Program" + chr$(13)
2220 color rgb(255,255,255)
2230 else
2240 color rgb(255,255,255)
2250 print chr$(13)
2260 sp_on 0,1:sp_put 0,(5,300),0,0
2270 print "番号を選んでください" + chr$(13)
2280 print " :1.数霊(かずたま)チェック" + chr$(13)
2290 print " :2.設定" + chr$(13)
2300 print " :3.ヘルプ" + chr$(13)
2310 print " :4.(プログラムを)終　了する" + chr$(13)
2320 color rgb(0,0,0)
2330 'No=1:locate 1,12:color rgb(255,255,255):print "数霊（かずたま）チェックを選択"
2340 'バーチャルパッドを表示
2350 No=1:
2360 'lang_flag:1 外国語,0:日本語
2370 if lang_flag = 1 then
2380 'lang_flag=1 英語
2390 locate 0,15:color rgb(0,0,0):print "1.It has selected Kazutama check";chr$(13)
2400 else
2410 'lang_flag=0 日本語
2420 locate 0,15:color rgb(0,0,0):print " 1.数霊(かずたま)チェックを選択";chr$(13)
2430 endif
2440 endif
2450 'TopScreen sprite
2460 'スプライト
2470 '選択肢 1 On
2480 'sp_def 0,(5,300),32,32
2490 'sp_on 0,1
2500 'sp_put 0,(5,300),0,0
2510 '選択肢 2 Off
2520 sp_def 1,(5,400),32,32
2530 sp_on 1,0
2540 sp_put 1,(5,400),0,0
2550 '選択肢 3 Off
2560 sp_def 2,(5,500),32,32
2570 sp_on 2,0
2580 sp_put 2,(5,500),0,0
2590 '選択肢 4 Off
2600 sp_def 3,(5,600),32,32
2610 sp_on 3,0
2620 sp_put 3,(5,600),0,0
2630 color rgb(0,0,0)
2640 Main_Select:
2650 'y:バーチャルパッドの処理
2660 'key$:カーソルの処理
2670 y = 0:key$ = "":bg = 0
2680 while (key$ <> chr$(31) and key$ <> chr$(13) and y <> 1 and y <> -1 and bg<>1)
2690 y = stick(1)
2700 key$ = inkey$
2710 bg = strig(1)
2720 pause 2
2730 wend
2740 'バーチャルパッドを押したときの処理とカーソルを押したときの処理を書く
2750 '1.バーチャルパッドの処理
2760 'バーチャルパッド下を押した時
2770 if y = 1 then
2780 select case No
2790 'No の初期値：No=1
2800 case 1:
2810 sp_on 0,0:sp_on 1,1:sp_on 2,0:sp_on 3,0:sp_put 1,(5,400),0,0:No=2:pause 200:locate 0,15:print "                                       ":
2820 if lang_flag = 1 then
2830 'lang_flag=1 英語
2840 locate 0,15:print "2.It has selected Setting":goto Main_Select:
2850 else
2860 'lang_flag=0 日本語
2870 locate 0,15:print " 2.設定を選択":goto Main_Select:
2880 endif
2890 'デバッグライン　ここから
2900 '0のとき
2910 'デバッグライン　ここまで
...
2930 'バーチャルパッド　下
2940 case 2:
2950 sp_on 2,1:sp_on 0,0:sp_on 1,0:sp_on 3,0:sp_put 2,(5,500),0,0:pause 200:No=3:locate 0,15:
2960 print "                                         ":
2970 if lang_flag = 1 then
2980 color rgb(0,0,0):locate 0,15:
2990 print "3.It has selected Help":No=3:goto Main_Select:
3000 else
3010 color rgb(0,0,0):locate 0,15:print "                                                         ":locate 0,15:
3020 print " 3.ヘルプを選択":No=3:goto Main_Select:
3030 endif
3040 'デバッグライン　ここまで
3050 case 3:
3060 sp_on 3,1:sp_on 0,0:sp_on 1,0:sp_on 2,0:sp_put 3,(5,590),0,0:pause 200:locate 0,15:print"                                               "
3070 if lang_flag = 1 then
3080 locate 0,15:print "4.It has selected finish program":No=0:goto Main_Select:
3090 else
3100 locate 0,15:print "                                                         " :locate 0,15:print " 4.(プログラムを)終了するを選択":No=0:goto Main_Select:
3110 endif
3120 'デバッグライン　ここから
3130 'locate 1,12:print"count=";count;chr$(13):count = count + 1:goto Main_Select:
3140 'デバッグライン　ここまで
3150 case 0:
3160 sp_on 0,1:sp_on 1,0:sp_on 2,0:sp_on 3,0:sp_put 0,(5,300),0,0:pause 200:No=1
3170 if lang_flag = 1 then
3180 'lang_flag=1:英語
3190 locate 0,15:print "1.It has selected Kazutama check":goto Main_Select:
3200 else
3210 'lang_flag=0:日本語
3220 locate 0,15:print "                                      ":locate 0,15:print " 1.数霊(かずたま)チェックを選択":goto Main_Select:
3230 endif
3240 'デバッグライン　ここから
...
5510 'デバッグライン　ここから
5520 case 3:
5530 sp_on 2,0:sp_on 1,0:sp_on 2,0:sp_on 3,0:sp_on 0,1:sp_put 0,(5,585),0,0:pause 200:locate 0,15:print "                                               "
...
6090 endif
6100 case 1:
6110 No=0:sp_on 0,0:sp_on 1,0:sp_on 2,1:sp_on 3,0:sp_put 2,(5,585),0,0:locate 0,12:print "                                                          ":
...
7740 gload Gazo$ + "Result_Screen3_20230319.png"
...
9800 case 1:
9810 sp_on 2,1:sp_on 0,0:sp_on 1,0:sp_on 3,0:sp_put 2,(5,500),0,0:pause 200:No=0:locate 0,15:print"                                       ":locate 0,15:print" 3.トップ画面に行くを選択":goto Help_key
...
9850 case 2:
9860 sp_on 0,1:sp_on 1,0:sp_on 2,0:sp_on 3,0:sp_put 0,(5,300),0,0:pause 200:No=1:locate 0,15:print "                                     ":locate 0,15:print" 1.バージョンを選択":goto Help_key:
9870 end select
9880 endif
9890 if bg = 1 then
9900 select case No
