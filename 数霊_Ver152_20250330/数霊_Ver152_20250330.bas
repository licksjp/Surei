...
'1.フォルダがない時
'終了処理
cls 3:color rgb(255,255,255):end
endif
'**********************************************************************************************
'2.ファイルの有無チェック
...
'登録リストを表示するところに飛ぶ
ui_msg "この機能はまだ未実装です。トップ画面に行きます。"
goto Read_Entry_Kazutama_Data:
'*************************************************************************************************************
end select
endif
...
'for j=0 to 1
'for i=0 to (Data_Memory_Tate - 1)
Title1_Kazutama_name$ = Buffer_Kazutama_Entry_Data$(0,0)
Title2_Kazutama_Number$ = Buffer_Kazutama_Entry_Data$(0,1)
print Title1_Kazutama_name$ , Title2_Kazutama_Number$ + chr$(13)
'next i
'next j
